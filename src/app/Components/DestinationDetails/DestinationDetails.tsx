            ...
            <div className="col-lg-8">
              <div className="destination-details-items">
                <div className="details-image">
                  <Image
                    src="/assets/img/details/destination-details.jpg"
                    alt="img"
                    width={856}
                    height={550}
                  />
                ...
                <div className="details-content">
                  ...
                  <div className="row g-4 mt-4 mb-4">
                    <div className="col-md-6">
                      <div className="details-image">
                        <Image
                          src="/assets/img/details/destination-details-2.jpg"
                          alt="img"
                          width={416}
                          height={411}
                        />
                    ...
                    <div className="col-md-6">
                      <div className="details-image">
                        <Image
                          src="/assets/img/details/destination-details-3.jpg"
                          alt="img"
                          width={416}
                          height={411}
                        />
                  ...
                  <div className="recent-post-area">
                    <div className="recent-items">
                      <div className="recent-thumb">
                        <Image
                          src="/assets/img/details/pp1.jpg"
                          alt="img"
                          width={100}
                          height={100}
                        />
                    ...
                    <div className="recent-items">
                      <div className="recent-thumb">
                        <Image
                          src="/assets/img/details/pp2.jpg"
                          alt="img"
                          width={100}
                          height={100}
                        />
                    ...
                    <div className="recent-items">
                      <div className="recent-thumb">
                        <Image
                          src="/assets/img/details/pp3.jpg"
                          alt="img"
                          width={100}
                          height={100}
                        />
